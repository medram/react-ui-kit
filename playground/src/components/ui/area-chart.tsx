...
import type { AreaChartContentProps, AreaChartDataItem } from "@/components/ui/area-chart-content"
...
const AreaChartContent = lazy(() => import("@/components/ui/area-chart-content"))
...
export default function AreaChart({
  ...
  return (
    <BaseChartCard
      ...
      onValueChange={(value) => onOptionChange?.(String(value))}
      {...baseChartCardProps}
