...
import type { Prettify } from "@medram/react-ui-kit/types"
import { formatCurrency } from "@/components/ui/medram-utils"
import { BaseChartCard, ChartFallback } from "@/components/ui/base-chart-card"
import type { RadarChartContentProps, RadarData, RadarGroup } from "@/components/ui/radar-chart-content"

const RadarChartContent = lazy(() => import("@/components/ui/radar-chart-content"))
